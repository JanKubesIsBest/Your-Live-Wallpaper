            ...
            VStack (alignment: .leading) {
                ...
                case .paywall(_):
                    ZStack {
                        ...
                        VStack (alignment: .leading) {
                            Text("Change the way your iPhone looks.")
                                .font(.title)
                                .fontWeight(.bold)
                            Text("Generate more wallpapers ✅")
                                .fontWeight(.bold)
                            Text("Animate them and make your iPhone experience unique ✅")
                                .fontWeight(.bold)
                            
                            Spacer()
                            
                            VStack {
                                MainButtonAction(text: "Pay Weekly - $4", tinted: false, action: {
                                    
                                })
                                
                                MainButtonAction(text: "Pay Yearly - $120", tinted: true, action: {
